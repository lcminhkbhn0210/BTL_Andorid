...
public class DB extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "bookstored.db";
    ...
    public List<Bill> getAllBill(){
        ...
        while (rs!=null && rs.moveToNext()){
            ...
            while (tokenizer.hasMoreTokens()){
                carts.add(getCartByid(Integer.parseInt(tokenizer.nextToken())));
    ...
    public List<Bill> getBillByMonth(int month){
        ...
        while (rs!=null && rs.moveToNext()) {
            ...
            if(Integer.parseInt(s)==month) {bills.add(bill);}
        }
        rs.close();
        return bills;
    }
